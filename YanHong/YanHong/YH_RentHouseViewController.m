...
@interface YH_RentHouseViewController ()

@end

@implementation YH_RentHouseViewController
...
-(void)httpData:(NSString *)pageNum
{
    ...
    NSString *strJson = [[NSString alloc] initWithFormat:@"{\"packmd5\":\"MD5MD5MDMD5MD5MDMD5MD5MDMD5MD5MD\",\"ver\":\"1.0\",\"command\":\"1059\",\"errcode\":\"000\",\"errmsg\":\"提示信息\",\"timestamp\":\"%@\",\"uid\":\"%@\",\"type\":\"%@\",\"page\":\"%@\",\"count\":\"%@\",\"apptype\":\"2 \"}",dateString,[[NSUserDefaults standardUserDefaults] objectForKey:@"uid"],@"2",pageNum,@"5"];
...
{
    [self.view.window showHUDWithText:nil Type:ShowDismiss Enabled:YES];
    TravelViewController *house=[[TravelViewController alloc] init];
